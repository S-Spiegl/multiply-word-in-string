...
describe('modifyMultiply', () => {
  ...
  it('works joins output with hyphen 1', () => {
    expect(modifyMultiply("This is a string",3,2)).toEqual("string-string")
  })
  it('works joins output with hyphen 2', () => {
    expect(modifyMultiply("This is a string",3 ,5)).toEqual("string-string-string-string-string")
  })
  it('works joins output with hyphen 3', () => {
    expect(modifyMultiply("Creativity is the process of having original ideas that have value. It is a process; it's not random.",8 ,10)).toEqual("that-that-that-that-that-that-that-that-that-that")
  })
  it('works joins output with hyphen 4', () => {
    expect(modifyMultiply("Self-control means wanting to be effective at some random point in the infinite radiations of my spiritual existence",1 ,1)).toEqual("means")
  })
  it('works joins output with hyphen 4=5', () => {
    expect(modifyMultiply("Is sloppiness in code caused by ignorance or apathy? I don't know and I don't care.",6 ,8)).toEqual("ignorance-ignorance-ignorance-ignorance-ignorance-ignorance-ignorance-ignorance")
  })
